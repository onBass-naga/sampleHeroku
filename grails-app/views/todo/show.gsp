...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'todoList.label', default: 'Todo')}" />
		...
		<div id="show-todoList" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${todoListInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
